...
AGRO_PROMPT = """
    ...
    Если нет значений для полей 'Вал за день, ц' и 'Вал с начала, ц', то оставляй их пустыми.
...
| 10/27/2024 | АОР            | Уборка   | Свекла сахарная  | 45          | 1 569                  | 12 596,80      | 66 606,30        |
    ...
    Верни ответ в виде таблицы в формате markdown, где каждая строка представляет одну операцию. Укажи количество найденных операций.
    </Инструкция>
"""